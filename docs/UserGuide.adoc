...
image::edit-changeTag-before.png[width="940px"]
...
image::edit-changeTag-after.png[width="940px"]
...
.Before command is run
image::edit-changephone-before.png[width="940px"]
...
.After command is run
image::edit-changephone-after.png[width="940px"]
