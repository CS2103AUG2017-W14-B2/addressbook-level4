...
.  A user with a passable understanding of technology and the English language should be able to operate the application without significant problems.
...
.  Should be able to work with the defualt email of mainstream-os.
